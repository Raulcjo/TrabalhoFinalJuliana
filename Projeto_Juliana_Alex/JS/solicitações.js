function Salvar(){
    ...
    col7.innerHTML = '<i class="bi bi-pencil-square" onclick="Editar()"></i>';
    col8.innerHTML = '<i class="bi bi-trash3" onclick="Remover()"></i>';
}
...
function Editar(){
    ...
    document.querySelector("pagamento").value = pagamento;
...
solicitacoes.forEach(function(tr) {
